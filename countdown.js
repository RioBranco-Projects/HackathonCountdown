...
function updateNumberWithAnimation(unit, value, digits) {
  ...
  if (previousValues[unit] !== null && previousValues[unit] !== value) {
    ...
    element.style.boxShadow =
      "0 0 30px rgba(249, 115, 22, 0.8), 0 8px 32px rgba(0, 0, 0, 0.3)";
    setTimeout(() => {
      element.style.boxShadow = "";
    }, 1000);
  } else {
...
function initializeInteractions() {
  ctaButton.addEventListener("mouseenter", function () {
    ...
    this.style.boxShadow =
      "0 0 40px rgba(249, 115, 22, 0.6), 0 8px 32px rgba(0, 0, 0, 0.3)";
  });
  ...
  Object.values(countdownElements).forEach((element) => {
    element.addEventListener("mouseenter", function () {
      ...
      this.style.boxShadow =
        "0 0 30px rgba(249, 115, 22, 0.3), 0 8px 32px rgba(0, 0, 0, 0.3)";
    });
